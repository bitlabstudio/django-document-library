...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.source_url'
        db.add_column('document_library_document', 'source_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Document.download_url'
        db.add_column('document_library_document', 'download_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'DocumentTitle.copyright_notice'
        db.add_column('document_library_documenttitle', 'copyright_notice',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.source_url'
        db.delete_column('document_library_document', 'source_url')

        # Deleting field 'Document.download_url'
        db.delete_column('document_library_document', 'download_url')

        # Deleting field 'DocumentTitle.copyright_notice'
        db.delete_column('document_library_documenttitle', 'copyright_notice')
