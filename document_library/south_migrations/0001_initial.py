...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('document_library', ['Document'])
        ...
        db.create_table('document_library_documenttitle', (
            ...
            ('filer_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('document_library_document')
