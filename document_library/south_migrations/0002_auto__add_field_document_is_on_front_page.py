...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.is_on_front_page'
        db.add_column('document_library_document', 'is_on_front_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.is_on_front_page'
        db.delete_column('document_library_document', 'is_on_front_page')
