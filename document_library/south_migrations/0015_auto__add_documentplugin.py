...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentPlugin'
        db.create_table('cmsplugin_documentplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document_library.Document'])),
        ))
        db.send_create_signal('document_library', ['DocumentPlugin'])


    def backwards(self, orm):
        # Deleting model 'DocumentPlugin'
        db.delete_table('cmsplugin_documentplugin')
