...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentTitle.is_published'
        db.add_column('document_library_documenttitle', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentTitle.is_published'
        db.delete_column('document_library_documenttitle', 'is_published')
