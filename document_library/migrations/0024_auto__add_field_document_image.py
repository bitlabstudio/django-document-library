...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'document_library_document', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'document_images', null=True, to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.image'
        db.delete_column(u'document_library_document', 'image_id')
