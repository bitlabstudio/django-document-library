...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_index('document_library_documentcategory', ['slug'])


        # Changing field 'DocumentCategory.slug'
        db.alter_column('document_library_documentcategory', 'slug', self.gf('django.db.models.fields.CharField')(max_length=32))
