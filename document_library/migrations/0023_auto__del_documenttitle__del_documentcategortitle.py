...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DocumentTitle'
        db.delete_table('document_library_documenttitle')

        # Deleting model 'DocumentCategoryTitle'
        db.delete_table('document_library_documentcategorytitle')

        # Removing M2M table for field placeholders on 'Document'
        db.delete_table(db.shorten_name('document_library_document_placeholders'))


    def backwards(self, orm):
        # Adding model 'DocumentTitle'
        db.create_table('document_library_documenttitle', (
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filer_file', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'document_files_old', null=True, to=orm['filer.File'], blank=True)),
            ...
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document_library.Document'])),
            ('thumbnail', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'document_thumbnails_old', null=True, to=orm['filer.File'], blank=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('document_library', ['DocumentTitle'])
        ...
        # Adding M2M table for field placeholders on 'Document'
        m2m_table_name = db.shorten_name('document_library_document_placeholders')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('document', models.ForeignKey(orm['document_library.document'], null=False)),
            ('placeholder', models.ForeignKey(orm['cms.placeholder'], null=False))
        ))
        db.create_unique(m2m_table_name, ['document_id', 'placeholder_id'])
