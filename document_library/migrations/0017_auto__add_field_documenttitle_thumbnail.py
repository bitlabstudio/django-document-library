...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentTitle.thumbnail'
        db.add_column('document_library_documenttitle', 'thumbnail',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='document_thumbnails', null=True, to=orm['filer.File']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentTitle.thumbnail'
        db.delete_column('document_library_documenttitle', 'thumbnail_id')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
