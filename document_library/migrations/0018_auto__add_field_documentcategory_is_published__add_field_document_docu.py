...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentCategory.is_published'
        db.add_column('document_library_documentcategory', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Document.document_date'
        db.add_column('document_library_document', 'document_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentCategory.is_published'
        db.delete_column('document_library_documentcategory', 'is_published')

        # Deleting field 'Document.document_date'
        db.delete_column('document_library_document', 'document_date')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 8, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'document_library.documenttitle': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['document_library.Document']"}),
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'document_files'", 'null': 'True', 'to': "orm['filer.File']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'meta_description': ('django.db.models.fields.TextField', [], {'max_length': '512', 'blank': 'True'}),
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'document_thumbnails'", 'null': 'True', 'to': "orm['filer.File']"}),
