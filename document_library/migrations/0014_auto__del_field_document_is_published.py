...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.is_published'
        db.delete_column('document_library_document', 'is_published')


    def backwards(self, orm):
        # Adding field 'Document.is_published'
        db.add_column('document_library_document', 'is_published',
