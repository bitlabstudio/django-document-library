...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('document_library_document_placeholders', (
        ...
        db.create_unique('document_library_document_placeholders', ['document_id', 'placeholder_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('document_library_document_placeholders')
