...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentCategory.slug'
        db.add_column('document_library_documentcategory', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentCategory.slug'
        db.delete_column('document_library_documentcategory', 'slug')
