...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.update_date'
        db.add_column('document_library_document', 'update_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.update_date'
        db.delete_column('document_library_document', 'update_date')
